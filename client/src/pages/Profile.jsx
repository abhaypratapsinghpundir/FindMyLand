  ...
  return (
    <div className='pd-3 max-width-lg mx-auto'>
      ...
      <form className=' flex flex-col gap-4'>
        ...
        <img onClick={()=>fileRef.current.click()} src={currentUser.avatar}alt="Profile" className='rounded-full h-24 w-24 object-cover cursor-pointer self self-center' mt-2/>
